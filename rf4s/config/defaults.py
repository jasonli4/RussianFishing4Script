...
# ---------------------------------------------------------------------------- #
_C.AUTH = CN()
_C.AUTH.API_URL = "http://120.55.246.246:8000/verify_card"
_C.AUTH.API_SECRET = "Fishing@2026#Card"
_C.AUTH.AES_KEY = ""  # 首次运行会自动生成32字节随机密钥
_C.AUTH.AUTH_FILE = "auth_info.bin"
